...
public class DeliveryRequest {
    ...
    public DeliveryRequest(UUID demand, String customer, String address, Integer addressNumber, Double deliveryPrice, Double productsWeight, List<DeliveryProduct> productList) {
        this.demand = demand;
